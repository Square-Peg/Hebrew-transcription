const { EC2Client, RunInstancesCommand, DescribeInstancesCommand, RequestSpotInstancesCommand, DescribeSpotInstanceRequestsCommand } = require('@aws-sdk/client-ec2');
...
python3 /opt/hebrew-transcription/transcribe.py
